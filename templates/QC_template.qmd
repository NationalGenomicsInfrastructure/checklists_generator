...
On the flowcell page, check the following:
...
- [ ] Enter the sequencing date in _All samples sequenced_
- [ ] Put your signature in the _Signature All samples sequenced_
- [ ] Check other fields for correctness (e.g. _Document Version_)
...
- [ ] Set the value of the _QC_ column accordingly (i.e. whether the sample has to be delivered of not)
