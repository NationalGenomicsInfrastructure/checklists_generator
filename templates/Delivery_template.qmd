...
- [ ] Check on [Charon](<charon_url>/project/<project_id>) that the _Delivery Status_ column changed from _STALE_ to *IN_PROGRESS*
...
- [ ] In CC, add the following people:
  ...
  - Bioinfo team leader
  - Project coordinator
- [ ] Set _Project ID_ field to <project_name> (format: `<username>_<year>_<index>`)
